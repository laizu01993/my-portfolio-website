        ...
        >
            ...
            `}
                    ...
                    >
                        ...
                        <p className="text-gray-700 dark:text-gray-200 font-medium text-center wrap-break-word">{method.value}</p>
            ...
            <motion.a
                href="https://mail.google.com/mail/?view=cm&fs=1&to=laizuaktar6@gmail.com"
                className="mt-12 mb-6 px-8 py-4 bg-linear-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white font-semibold rounded-full shadow-2xl transition-all duration-300"
